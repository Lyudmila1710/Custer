...
if ( ! class_exists( 'Hodophile_Editors_Choice' ) ) :

     
    class Hodophile_Editors_Choice extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_editors_choice = array(
                ...
                'description' => esc_html__( 'Retrive Editors Choice.', 'hodophile' ),
            );
            $this->default_title = __( 'Top Posts &amp; Pages', 'hodophile' );

            parent::__construct( 'hodophile_editors_choice', esc_html__( 'TP : Editors Choice', 'hodophile' ), $tp_widget_editors_choice );
        ...
        public static function defaults() {
            return array(
                'title'    => esc_html__( 'Editor Choice ', 'hodophile' ),
                'count'    => absint( 4 ),
                'types'    => 'post',
                'category'  => '',
