...
class Hodophile_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'hodophile';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'hodophile' ), $i ),
...
// Initialize.
$hodophile_footer_widgets = new Hodophile_Footer_Widgets();
