 ...
 */
class Hodophile_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Hodophile_Dropdown_Category_Control extends WP_Customize_Control {
...
class Hodophile_Note_Control extends WP_Customize_Control {
...
class Hodophile_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Hodophile_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="hodophile-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Hodophile_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Hodophile_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="hodophile-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="hodophile-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu hodophile-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="hodophile-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Hodophile_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
	            ...
	            <?php } ?>
	            <input id="hodophile-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'hodophile' ); ?>" class="hodophile-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
...
class Hodophile_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Hodophile_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
